...
public class DekoratorStreetLights extends AbstractDekorator {
    ...
    public DekoratorStreetLights(AppCompatActivity activity, AbstractModbusSlave modbusSlave) {
    ...
    public void initUiElements() {
        ...
        register2TextView = activity.findViewById(R.id.reg2Text);
    }
    ...
    public void update() throws IllegalDataAddressException {
        ...
        register2TextView.setText(
                String.valueOf(modbusSlave.getAllRegisters().get(2))
        );
